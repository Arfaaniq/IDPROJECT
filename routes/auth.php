...
Route::prefix('web')->middleware('auth:web')->group(function () {
    ...
    // ================================================================
    Route::get('/orderservice', [VerifyController::class, 'showOrderForm'])
        ->name('orderservice.form');
    Route::post('/orderservice', [VerifyController::class, 'order'])
        ->name('orderservice');

    // ================================================================
    // Customer Status & Invoice Management
    // ================================================================
    Route::get('/customer/status', [CustomerController::class, 'status'])
        ->name('customer.status');
    Route::get('/invoice/download/{order}', [CustomerController::class, 'downloadInvoice'])
    ...
    Route::get('/invoice/download/{id}', [CustomerController::class, 'downloadInvoice'])
        ->name('invoice.download');
});
