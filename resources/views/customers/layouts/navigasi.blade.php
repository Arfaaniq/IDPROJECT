  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav" >
      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('home') ? 'active' : '' }}" href="{{ route('home') }}" style="color: black;">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('about') ? 'active' : '' }}" href="{{ route('about') }}" style="color: black;">About us</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('service') ? 'active' : '' }}" href="{{ route('service') }}" style="color: black;">Service</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('blog') ? 'active' : '' }}" href="{{ route('blog') }}" style="color: black;">Blog</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('customer.projects') ? 'active' : '' }}" href="{{ route('customer.projects') }}" style="color: black;">Portofolio</a>
        </li>
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          <!-- Item menu lainnya -->
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('orderservice*') ? 'active' : '' }}"
              ...
              id="orderServiceLink" style="color: black;">
              Order Service
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('customer.status') ? 'active' : '' }}"
              ...
              id="statusLink" style="color: black;">
              Status
            </a>
          </li>
        </ul>
